    ...
    >
      <div className="flex items-center h-full justify-between w-[95%] sm:w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-4">
          {/* Login button */}
          <div className="flex items-center cursor-pointer text-white space-x-2 hover:text-blue-300 transition-all duration-200">
        ...
        <HiBars3BottomRight
          onClick={openNav}
          className="sm:w-8 sm:h-8 w-6 cursor-pointer text-white lg:hidden"
        />
      </div>
    </div>
  );
