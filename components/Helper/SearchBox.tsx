      ...
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center flex-[0.2] ml-8 space-x-6">
          <div className="lg:flex hidden items-center cursor-pointer space-x-2 ">
            <HiAdjustments className="text-gray-700 w-6 h-6 " />
            <p className="text-gray-700 font-semibold">Advanced</p>
          </div>
          <div className="w-12 h-12 bg-blue-600 flex items-center hover:bg-blue-800 transition-all duration-150 cursor-pointer justify-center text-white rounded-full">
            <FaSearch />
          </div>
        </div>
      </div>
